...
func ModuleDownloadUrl(ctx context.Context, cfg api.Config, source, version string) (string, error) {
	...
	info, err := client.ModuleVersions().GetDownloadInfo(ctx, ms.OrgName, ms.ModuleName, version)
	if err != nil {
